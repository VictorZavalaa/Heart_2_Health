...
import RecomendacionForm from './Components/Doctor/Recomendacion/RecomendacionForm.jsx';
...
import ListaRecomendaciones from './Components/Paciente/ListaRecomendaciones.jsx';
...
const Router = createBrowserRouter([
    ...
    */
    ...
    {
        path: '/Doctor/Citas/:id/Recomendaciones', //Lista de recomendacion
        element: (
            <ProtectedRoute role="doctor"> 
                <Recomendaciones />
            </ProtectedRoute>
    ...
    {
        path: '/Doctor/Citas/:idC/Recomendaciones/new', //Registro de recomendacion
        element: (
            <ProtectedRoute role="doctor"> 
    ...
    {
        path: '/Doctor/Citas/:idC/Recomendaciones/:id', //Actualizar recomendacion
        element: (
            <ProtectedRoute role="doctor"> 
    ...
    {
        path: '/Paciente/Citas/:id/Recomendaciones', //Lista de recomendaciones
        element: (
            <ProtectedRoute role="paciente"> 
