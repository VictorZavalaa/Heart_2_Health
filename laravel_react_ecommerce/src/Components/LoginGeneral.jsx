            ...
            <div className={`form-container ${!isSignIn ? 'sign-up' : 'sign-in'}`}>
              {isSignIn ? (
                <form onSubmit={SubmitDoctor}>
                  <h1>Inicio de sesión Doctores</h1> 
    
                  <span>Ingrese su correo y contraseña para iniciar sesión como doctor</span>
          ...
          <div className="toggle-container">
            ...
            <div className="toggle">
              <div className="toggle-panel toggle-left">
                ...
                <p>Ingrese su correo y contraseña para iniciar sesión como Doctor</p>
              ...
              <div className="toggle-panel toggle-right">
                ...
                <p>Ingrese su correo y contraseña para iniciar sesión como Paciente</p>
